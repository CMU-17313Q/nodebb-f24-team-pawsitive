    ...
    if (solvedButton) {
        solvedButton.addEventListener('click', function(e) {
            ...
            if (isSolved) {
                ...
                solvedButton.querySelector('i').className = 'fa fa-fw fa-square text-danger';
                solvedButton.querySelector('.solved-text').className = 'solved-text text-danger';
                solvedButton.querySelector('.solved-text').textContent = 'Mark As Solved';
            } else {
                solvedButton.setAttribute('data-solved', 'true');
                solvedButton.querySelector('i').className = 'fa fa-fw fa-check text-success';
                solvedButton.querySelector('.solved-text').className = 'solved-text text-success';
